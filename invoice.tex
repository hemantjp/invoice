...
\vfill
%\fbox{
\begin{minipage}[][][c]{.9\textwidth}\begin{center}{\bfseries \Large Date of Issue:}\vspace{.25cm}\\{\Large {\tt 29\ts{th}November 2017}}\end{center}
\end{minipage}
%}
\vfill
%\fbox{
...
\item {\bfseries Duration}: {\itshape 2\ts{nd} November 2017 - 24\ts{th} November 2017.}
