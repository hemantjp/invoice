...
\vfill
\fbox{
\begin{minipage}[][][c]{.9\textwidth}{\bfseries \Large Date of Issue:}\vspace{.25cm}\\{\Large {\tt 1\ts{st}November 2017}}
\end{minipage}%
}
\vfill
\fbox{
...
\multirow{2}{10cm}{{\large Professional fees towards consultation service}\\  {\rupee~77000} per 22 days} & \begin{center}{\large\rupee~77000}\end{center} \\ 
\end{tabular}
\vspace{.35cm}\\
\hspace*{3mm}Details:
...
\item {\bfseries Period}: {\itshape 28\ts{th} September 2017 - 1\ts{st} November 2017.}
